...
from home.views.admin_recordings import AdminRecordingsListView  # 🎙️ NEW IMPORT
...
from home.views.recording_callback import recording_callback
...
urlpatterns = [
    ...
    path("admin/recordings/", AdminRecordingsListView.as_view(), name="admin_recordings"),  # 🎙️ NEW
    ...
    path("twilio/recording-callback/", recording_callback, name="twilio_recording_callback"),
